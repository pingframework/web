...
class RequestBodySchemaList implements Injector
{
    ...
    public function inject(
        ...
        return $c->get(ObjectMapperInterface::class)->mapFromJsonList(
            (string)$runtime[ServerRequestInterface::class]->getBody(),
            $this->type
        );
    }
}
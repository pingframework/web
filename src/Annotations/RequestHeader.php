...
class RequestHeader implements Injector
{
    ...
    public function inject(
        ...
        return (string)$runtime[ServerRequestInterface::class]->getHeaderLine(
            $this->name ?? Strings::camelCaseToUnderscore($rp->getName())
        );
    }
}